...
8. For meaningful post-launch, closeout, or delivery-state work, update `PHASE7.md` and the relevant GitHub issue notes before final handoff. If a finding is not already tracked, create a new issue rather than leaving it only in chat.
