...
The estimate below assumes the first event remains focused on food/vendor ordering and does not add full ticketing, QR scanning, admission control, or major new features. The final number should depend on the decisions made in this meeting, the quality of the remaining client inputs, and what the 23-24 May testing shows.
...
| --- | ---: | ---: |
| Launch planning, decision capture, and scope lock | 1-2 hours | R500 - R1,000 |
| Environment and provider parity checks | 2-4 hours | R1,000 - R2,000 |
| Sandbox group test preparation and support | 2-3 hours | R1,000 - R1,500 |
| Controlled live Stripe test and reconciliation check | 1-3 hours | R500 - R1,500 |
| Vendor readiness and final launch data support | 1-4 hours | R500 - R2,000 |
| Notification/email/WhatsApp fallback verification | 1-2 hours | R500 - R1,000 |
| Final launch checklist, issue triage, and go/no-go pack | 2 hours | R1,000 |
| **Phase 6 launch activation estimate** | **10-20 hours** | **R5,000 - R10,000** |

Optional reduced ticket-vendor setup, if approved by 24 May 2026, should be treated as an additional 10-15 hours / R5,000 - R7,500. This includes basic setup, ticket products, test purchases, admin/vendor monitoring, and launch notes, but does not include QR generation, QR scanning, or door/admission tooling.
...
Proposed event-day support pricing for discussion: R500/hour for remote standby or active event support, with the minimum support window, channel, escalation contact, and payment timing agreed in writing before the event.
...
Estimated effort: 10-15 hours / R5,000 - R7,500 if approved by 24 May 2026, assuming SKIIP supplies the ticket names, prices, quantities, event wording, refund/admission rules, and test users quickly.
...
> The aim of this meeting is to leave with clear written decisions so the launch can move forward without confusion. The platform is close, but the remaining commercial position, V1 scope, provider setup, testing, and support ownership need to be confirmed now. If something is not ready - especially WhatsApp, ticketing, or provider-dependent work - the safer route is to defer it rather than rush it into the first launch. A focused, paid, properly supported first event gives SKIIP the best chance of launching well.
