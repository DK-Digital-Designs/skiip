...
7. The first-event fee holiday sets both the buyer service fee and Stripe Connect application fee to GBP 0; Stripe processing fees are still retrieved and recorded during reconciliation.
