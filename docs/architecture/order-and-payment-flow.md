...
7. The Stripe application fee is currently computed as `10%` of the order subtotal plus the fixed GBP 1.50 `Service Fees` line and passed as `application_fee_amount`.
