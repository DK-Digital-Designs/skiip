...
16. confirm a full linked-order refund reverses the Connect transfer path, records the actual Stripe fee behavior, and does not depend on case submission alone
