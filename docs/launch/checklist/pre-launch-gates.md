...
- the rehearsal confirms the GBP 1.50 service fee, unchanged `10%` subtotal application-fee portion, refund transfer reversal, and paid vendor-cancellation review case
