...
5. verify the new order has a GBP 1.50 service fee and a 0% Connect percentage application fee, while Admin Orders still shows the Stripe payment intent, charge, actual Stripe fee, and vendor net
